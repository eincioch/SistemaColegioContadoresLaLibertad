...
Public Class rptFichaIndividual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Integration.Test.rptFichaIndividual.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedrptFichaIndividual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFichaIndividual = New rptFichaIndividual()
        rpt.Site = Me.Site
        Return rpt
    End Function
