...
Public Class rptFormatoReciboIngresoFac
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFormatoReciboIngresoFac.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Integration.Test.rptFormatoReciboIngresoFac.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedrptFormatoReciboIngresoFac
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFormatoReciboIngresoFac = New rptFormatoReciboIngresoFac()
        rpt.Site = Me.Site
        Return rpt
    End Function
