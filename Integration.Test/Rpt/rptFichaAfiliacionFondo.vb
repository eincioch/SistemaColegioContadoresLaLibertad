...
Public Class rptFichaAfiliacionFondo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFichaAfiliacionFondo.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Integration.Test.rptFichaAfiliacionFondo.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedrptFichaAfiliacionFondo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFichaAfiliacionFondo = New rptFichaAfiliacionFondo()
        rpt.Site = Me.Site
        Return rpt
    End Function
